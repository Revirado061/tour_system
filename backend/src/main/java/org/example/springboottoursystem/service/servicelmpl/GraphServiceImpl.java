...
import org.example.springboottoursystem.repository.BuildingDao;
import org.example.springboottoursystem.repository.EdgeDao;
import org.example.springboottoursystem.repository.FacilityDao;
import org.example.springboottoursystem.repository.NodeDao;
...
public class GraphServiceImpl implements GraphService {
    ...
    @Autowired
    public GraphServiceImpl(NodeDao nodeDao, EdgeDao edgeDao, BuildingDao buildingDao, FacilityDao facilityDao) {
    ...
    public List<Node> findShortestLength(String start, List<String> terminal) {
        List<Edge> table = edgeDao.findAll();
    ...
    public List<Node> findShortestRoute(double[][] graph, String start, List<String> terminal) {
        Node s = nodeDao.findByName(start);
        ...
        while(true){
            ...
            for(String tNode : terminal){
                Node t = nodeDao.findByName(tNode);
